    ...
    return(
        <Center flex={1}>
            <VStack w={['95%','90%', '85%','80%','40%']} alignContent={'center'} justifyContent={'center'}>
                <Box minH={72} bg={'blueGray.50'}></Box>
                <Heading fontSize={'4xl'} mb={3} textAlign={'center'} mt={4} color={'#424242'}>The Ultimate Financial Management App</Heading>
                <Text textAlign={'center'} fontSize={'lg'} lineHeight={35} pb={4} my={2} px={4} color={'#707070'}>Stay in control of your finances, pay bills, and manage your accounts on-the-go with CashFlow Mobile - The Secure and Convenient Way to Bank.</Text>
