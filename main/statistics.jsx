...
export default function Statistics(){
    return(
        <Box flex={1} p={4} pt={8}  bg={'blueGray.100'}>
            ...
            <Box h={64}>
                <Box h={48} bg={'blueGray.500'} position={'relative'} rounded={'xl'}>
                    <Flex position={'absolute'} top={'80%'} justifyContent={'center'} alignItems = {'center'} w={'full'}>
                        <HStack bg={'white'} h={24} w={'80%'} shadow={'lg'}
                            ...
                            <VStack >
                                <Text color={'blueGray.500'} fontSize={'sm'}>Earned</Text>
                                <Heading>$2,730</Heading>
                            </VStack>
                            <VStack >
                                <Text fontSize={'sm'} color={'blueGray.500'}>Spent</Text>
                                <Heading>$2,730</Heading>
                            </VStack>
                        </HStack>
            ...
            <HStack justifyContent={'space-evenly'} mb={2}>
                <VStack w={'48%'}  p={2} alignItems={'center'} bg={'white'} rounded={'xl'} h={48}>
                    <Box h={24} bg={'blueGray.100'}></Box>
                    <Text fontWeight={'medium'} fontSize={'lg'}> Lunch and Dinner</Text>
                    <Text fontSize={'sm'} pb={4} color={'blueGray.400'}> $450</Text>
