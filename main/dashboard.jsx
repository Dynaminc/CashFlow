                ...
                {actionData.slice(0,4).map(data=>(
                    <Pressable w={'25%'} size={'lg'} key={data.name}>
                        <VStack alignItems={'center'} >
                            <Circle size={'sm'} bg={'gray.500'}></Circle>
...
function Transactions(){
    ...
    return(
        <>
        {data.map((item)=>(
            <HStack justifyContent={'space-between'} alignItems='center' py={2} pr={2} key={item} borderBottomWidth={1} borderColor={'gray.200'}>
                <Box w={12} h={12} rounded={'lg'} mr={2} bg={'red.100'}></Box>
                <Box minW={'65%'} h={'full'}>
                    <Text fontWeight={'medium'} ml={1} color={'gray.700'} fontSize={'lg'}>Shopping</Text>
                    <Text  color={'gray.400'}> 14/06/23</Text>
                </Box>
        ...
        <Box flex={1} w={'full'} pb={4}>
            <HStack p={4} justifyContent={'space-between'} shadow={'xl'} bg={'white'} pt={8}>
                <Box>
                    ...
                    <Text fontSize={'lg'} color={'gray.600'} textAlign={'center'}> Olamidotun David</Text>
                </Box>                    
                <Box h={'full'} w={16} bg={'gray.500'} rounded={'sm'}></Box>
            </HStack>
            <ScrollView w={'full'} p={4}>
                ...
                <HStack p={4} bg={'gray.200'} shadow={'xl'} rounded={'lg'} my={4} justifyContent={'space-between'} pb={4}>
                    <Box>
                        <Heading fontWeight={'bold'} pt={4} pb={1} fontSize={'xl'}> Get $80 bonus </Heading>                  
                        <Text  color={'gray.500'} pb={4} ml={1} fontSize={'lg'}> for each new user you invite </Text>
                        <Button
                            size={'sm'}
                            w={'50%'}
                            h={12}
                    ...
                    <Box bg={'gray.300'} w={'30%'} h={'full'} rounded={'lg'}></Box>
                </HStack>
            </ScrollView>
